        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="font-semibold text-lg">CampusEvents</span>
            </div>
            <p className="text-muted-foreground text-sm">
              Discover and engage with campus events. Never miss out on what matters to you.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/calendar" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  Calendar
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/my-events" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  My Events
                </Link>
              </li>
              <li>
                <Link to="/notifications" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  Notifications
                </Link>
              </li>
              <li>
                <Link to="/settings" className="text-muted-foreground hover:text-primary text-sm transition-colors">
                  Settings
                </Link>
              </li>
            </ul>
